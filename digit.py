...
image = cv2.imread('/home/paa/my/opencv/Master OpenCV/images/digits.png')
...
image = cv2.imread('/home/paa/my/opencv/Master OpenCV/images/numbers.jpg')
gray = cv2.cvtColor(image, cv2.COLOR_BGR2GRAY)
...
# for (i, c) in enumerate(contours):
#   contourcenter = label_center(image, c)
# cv2.imshow("Contour Center",contourcenter)
cv2.waitKey(0)
